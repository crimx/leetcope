...
Pick a pivot point `(row, col)` and assume it is on the base line. The adjoining `1`s above `(row, col)` is the height of the rectangle. Then expanding horizontally we have the width of the rectangle.
